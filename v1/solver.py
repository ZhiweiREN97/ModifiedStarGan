...
class Solver(object):
    ...
    def train(self):
        ...
        #x_v_fixed = torch.randn(self.batch_size, 100, 1, 1, device=self.device)

        x_fixed = x_fixed.to(self.device)
        x_v_fixed = torch.randn(x_fixed.size(0), 200, 1, 1, device=self.device)
        ...
        for i in range(start_iters, self.num_iters):
            ...
            try:
                ...
                ###Modify
                #print (x_real.size(),x_real.view(0))
            ...
            x_v = torch.randn(x_real.size(0), 200, 1, 1, device=self.device)
            # =================================================================================== #
            ...
            if (i+1) % self.sample_step == 0:
                with torch.no_grad():
                    ...
                    for c_fixed in c_fixed_list:
                        x_fake_list.append(self.G(x_v_fixed, c_fixed))
